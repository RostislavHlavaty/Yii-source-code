    ...
    <div class="box box-primary">
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php echo CHtml::link(Yii::t('app', 'Create new'), array('customer_groups/create'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Create new')));?>
                <?php echo CHtml::link(Yii::t('customers', 'Manage customers'), array('customers/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('customers', 'Manage customers')));?>
                <?php echo CHtml::link(Yii::t('app', 'Refresh'), array('customer_groups/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Refresh')));?>
            </div>
