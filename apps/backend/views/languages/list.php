    ...
    <div class="box box-primary">
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php echo CHtml::link(Yii::t('languages', 'Upload language pack'), '#language-upload-modal', array('class' => 'btn btn-primary btn-xs', 'data-toggle' => 'modal', 'title' => Yii::t('languages', 'Upload language pack')));?>
