            ...
            <div class="col-lg-2 col-xs-6">
                <div class="small-box bg-maroon">
                    <div class="inner">
                        ...
                        <p><?php echo Yii::t('dashboard', 'Leads in Database');?></p>
                    </div>
                    <div class="icon">
    ...
    <section class="col-lg-6" id="subscribers-growth-box" data-source="<?php echo $this->createUrl('dashboard/subscribers_growth');?>">
        <div class="box box-primary">
            <div class="box-header" id="subscribers-growth-header">
                <h3 class="box-title"><i class="fa fa-bar-chart-o"></i> <?php echo Yii::t('dashboard', 'Leads in Database');?></h3>
                <div class="box-tools pull-right">
