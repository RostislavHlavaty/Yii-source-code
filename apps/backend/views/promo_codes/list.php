    ...
    <div class="box box-primary">
        <div class="box-header">
    		...
    		<div class="pull-right">
    			<?php echo CHtml::link(Yii::t('app', 'Create new'), array('promo_codes/create'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Create new')));?>
                <?php echo CHtml::link(Yii::t('app', 'Refresh'), array('promo_codes/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Refresh')));?>
    		</div>
    	</div>
        <div class="box-body">
