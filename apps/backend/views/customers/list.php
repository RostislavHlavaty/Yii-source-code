    ...
    <div class="box box-primary">
        <div class="box-header">
            ...
            <div class="pull-right">
                ...
                <?php echo CHtml::link(Yii::t('customers', 'Manage groups'), array('customer_groups/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('customers', 'Manage groups')));?>
                <?php echo CHtml::link(Yii::t('app', 'Refresh'), array('customers/index'), array('class' => 'btn btn-primary btn-xs', 'title' => Yii::t('app', 'Refresh')));?>
            </div>
                        ...
                        array(
                            ...
                            'buttons'   => array(
                                ...
                                'delete' => array(
                                    ...
                                    'visible'   => '$data->removable === Customer::TEXT_YES',
                                ),    
                            ),
                            'htmlOptions' => array(
                                'style' => 'width:130px;',
