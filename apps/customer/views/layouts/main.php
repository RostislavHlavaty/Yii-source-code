...
<body class="skin-blue">
    <header class="header">
            <a href="<?php echo $this->createUrl('dashboard/index');?>" class="logo icon">
                <?php echo Yii::t('app', 'Customer area');?>
            </a>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                <li class="user-header bg-light-blue">
                                    <img src="<?php 
/* echo Yii::app()->customer->getModel()->getGravatarUrl(90); */
echo "http://leadinsiteportal.com/leadinsitemail/latest/CenterlogoforLIS-01.png";
?>" class="img-circle"/>
                                    <p>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            <aside class="left-side sidebar-offcanvas">
				...
				/* echo Yii::app()->customer->getModel()->getGravatarUrl(); */
					echo "http://leadinsiteportal.com/leadinsitemail/latest/CenterlogoforLIS-01.png";
