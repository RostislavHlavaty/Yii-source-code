...
class CustomerActionLogBehavior extends CBehavior
{
    ...
    public function listCreated(Lists $list)
    {
    ...
    public function listUpdated(Lists $list)
    {
        if (empty($this->owner->customer_id)) {
            return false;
        }
    ...
    public function listImportStart(Lists $list, ListImportAbstract $import)
    {
        if (empty($this->owner->customer_id)) {
            return false;
        }
    ...
    public function listImportEnd(Lists $list, ListImportAbstract $import)
    {
        if (empty($this->owner->customer_id)) {
            return false;
        }
    ...
    public function listExportStart(Lists $list, ListCsvExport $export)
    {
        if (empty($this->owner->customer_id)) {
            return false;
        }
    ...
    public function listExportEnd(Lists $list, ListCsvExport $export)
    {
        if (empty($this->owner->customer_id)) {
            return false;
        }
    ...
    public function listDeleted(Lists $list)
    {
        if (empty($this->owner->customer_id)) {
            return false;
        }
    ...
    public function segmentCreated(ListSegment $segment)
    {
        if (empty($this->owner->customer_id)) {
            return false;
        }
    ...
    public function segmentUpdated(ListSegment $segment)
    {
        $segUrl = Yii::app()->options->get('system.urls.customer_absolute_url');
        $segUrl = $segUrl . sprintf('lists/%s/segments/%s/update', $segment->list->uid, $segment->segment_uid);
    ...
    public function segmentDeleted(ListSegment $segment)
    {
        if (empty($this->owner->customer_id)) {
            return false;
        }
    ...
    public function campaignScheduled(Campaign $campaign)
    {
        if (empty($this->owner->customer_id)) {
            return false;
        }
    ...
    public function campaignSent(Campaign $campaign)
    {
        if (empty($this->owner->customer_id)) {
            return false;
        }
    ...
    public function subscriberCreated(ListSubscriber $subscriber)
    {
        if (empty($this->owner->customer_id)) {
            return false;
        }
    ...
    public function subscriberUpdated(ListSubscriber $subscriber)
    {
        if (empty($this->owner->customer_id)) {
            return false;
        }
    ...
    public function subscriberDeleted(ListSubscriber $subscriber)
    {
        if (empty($this->owner->customer_id)) {
            return false;
        }
    ...
    public function subscriberUnsubscribed(ListSubscriber $subscriber)
    {
        if (empty($this->owner->customer_id)) {
            return false;
        }
