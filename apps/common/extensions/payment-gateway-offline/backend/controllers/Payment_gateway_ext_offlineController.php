...
class Payment_gateway_ext_offlineController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $this->setData(array(
            'pageMetaTitle'     => $this->data->pageMetaTitle . ' | '. Yii::t('ext_payment_gateway_offline', 'Stripe payment gateway'),
            'pageHeading'       => Yii::t('ext_payment_gateway_offline', 'Stripe payment gateway'),
