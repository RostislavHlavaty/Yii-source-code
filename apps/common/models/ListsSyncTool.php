...
class ListsSyncTool extends FormModel
{
    ...
    public function getPrimaryList()
    {
        ...
        return $this->_primaryList = Lists::model()->findByAttributes(array(
            'list_id'      => (int)$this->primary_list_id,
    ...
    public function getSecondaryList()
    {
        ...
        return $this->_secondaryList = Lists::model()->findByAttributes(array(
            'list_id'      => (int)$this->secondary_list_id,
            'customer_id'  => (int)$this->customer_id,
        ));
    }
    ...
    public function getAsDropDownOptionsByCustomerId()
    {
        ...
        $models = Lists::model()->findAll(array(
            ...
            'params'    => array(':cid' => $this->customer_id),
            'order'     => 'name ASC',
        ));
